...
EMBEDDED_SKILLS['analyzer'] = _embedded_text([
    '---',
    'name: analyzer',
...
EMBEDDED_SKILLS['code_writer'] = _embedded_text([
    '# Skill: code_writer',
    '',
...
EMBEDDED_SKILLS['command_runner'] = _embedded_text([
    '---',
    'name: command_runner',
...
EMBEDDED_SKILLS['evaluator'] = _embedded_text([
    '---',
    'name: evaluator',
    'description: >',
...
EMBEDDED_SKILLS['nvbug_collector'] = _embedded_text([
    '---',
...
EMBEDDED_SKILLS['prompt_analyzer'] = _embedded_text([
...
EMBEDDED_SKILLS['reviewer'] = _embedded_text([
    '---',
    'name: reviewer',
...
EMBEDDED_SKILLS['workflow_designer'] = _embedded_text([
...
EMBEDDED_SKILLS['yaml_writer'] = _embedded_text([
    '# Skill: yaml_writer',
    '',
...
EMBEDDED_ASSETS['builtin/planner/skills/prompt_analyzer/SKILL.md'] = _embedded_text([
    '# Skill: prompt_analyzer',
    '',
    "You are the first node of camflow's builtin Planner workflow. The user",
    'ran `camflow run "<prompt>"`; your job is to **parse that prompt into a',
...
EMBEDDED_ASSETS['builtin/planner/skills/workflow_designer/SKILL.md'] = _embedded_text([
    '# Skill: workflow_designer',
    '',
    'Second node of the builtin Planner workflow. You take the',
    '`task_statement` produced by `prompt_analyzer` and design a DAG of',
...
EMBEDDED_ASSETS['builtin/planner/skills/yaml_writer/SKILL.md'] = _embedded_text([
    '# Skill: yaml_writer',
    '',
    'Third (last) node of the builtin Planner workflow. You take the DAG',
    'produced by `workflow_designer` and emit a syntactically valid',
...
EMBEDDED_ASSETS['builtin/planner/workflow.yaml'] = _embedded_text([
    'workflow: planner',
    'version: "1.1"',
    '',
    'goal: |',
